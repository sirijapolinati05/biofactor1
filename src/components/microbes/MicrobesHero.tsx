import heroBg from "@/assets/images/microbes-hero.jpg";
  ...
  return (
    <section className="bg-[#e7f2e8] pt-6 px-6">
      ...
      >
        ...
        {/* Top Left Cut Shape (Same as HeroSection) */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center px-6 py-24 md:py-32">
          ...
          <div className="max-w-md mx-auto lg:ml-auto text-center lg:text-left">
            ...
            <p className="text-lg text-white/80 mb-8">
              Transforming agriculture through beneficial microbes that restore
              soil health, enhance plant growth, and create sustainable farming ecosystems.
            </p>
